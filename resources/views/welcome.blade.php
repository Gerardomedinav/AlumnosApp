  ...
  <div class="min-h-screen flex flex-col items-center px-4 py-8">
    ...
    <div class="relative w-full max-w-4xl overflow-hidden rounded-xl shadow-lg mb-8">
      <div id="carousel" class="flex transition-transform duration-700 ease-in-out">
        <img src="{{ asset('/images/utn-1.jpeg') }}" class="w-full flex-shrink-0 object-cover" alt="Instalaciones UTN">
        <img src="{{ asset('/images/utn-2.jpg') }}" class="w-full flex-shrink-0 object-cover" alt="Laboratorio UTN">
        <img src="{{ asset('/images/utn-3.jpg') }}" class="w-full flex-shrink-0 object-cover" alt="Aulas UTN">
      </div>
      <!-- Controles -->
